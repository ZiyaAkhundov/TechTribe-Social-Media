...
<div className="chat-box flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen">
   ...
   <div className="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
      <div className="relative flex">
         ...
         <textarea type="text" id="chatint" rows="1" placeholder="Write your message!" value={inputStr} onChange={e => setInputStr(e.target.value)} className="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3"/>
